...
If you get error >>>>>> Message: Failed to complete #converge action: [SSL_connect returned=1 errno=0 state=SSLv3 read server certificate B: certificate verify failed] please follow these instructions (https://gist.github.com/fnichol/867550)
